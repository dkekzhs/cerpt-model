...
파일의 역할을 섞지 않기 위해 문서를 다음처럼 나눴다.

- `docs/research/`: CERPT의 연구 목표, 구조, 가설, 평가와 장기 로드맵
- `docs/implementation/`: 현재 구현 중인 Decoder-only CERPT Base와 기술적 제한
- `docs/guides/`: 학습, 멀티모달 실행, GitHub/Hugging Face 공개 방법
- `docs/data/`: 데이터셋 카드와 한국어 데이터 생성·준비 기록
- `docs/model-cards/`: Hugging Face에 공개할 모델 설명
- `docs/progress/`: 날짜별 학습 및 실험 진행 기록

상세한 읽기 순서는 [docs/README.md](./docs/README.md)에 정리했다.

### 연구 설계 문서

| 파일 | 내용 |
|---|---|
| [01-goals-and-success-criteria.md](./docs/research/01-goals-and-success-criteria.md) | 연구 목표, 성공 기준, 비목표 |
| [02-research-hypotheses.md](./docs/research/02-research-hypotheses.md) | 핵심 연구 가설과 검증 가능한 주장 |
| [03-system-architecture.md](./docs/research/03-system-architecture.md) | 전체 모델 구조와 데이터 흐름 |
| [04-state-and-program-design.md](./docs/research/04-state-and-program-design.md) | workspace, operator, controller 상세 설계 |
| [05-certification-and-verification.md](./docs/research/05-certification-and-verification.md) | evidence 검증, commit/rollback, shortcut 방지 |
| [06-training-strategy.md](./docs/research/06-training-strategy.md) | 사전학습, curriculum, 손실 함수, 데이터 구성 |
| [07-experiment-and-evaluation.md](./docs/research/07-experiment-and-evaluation.md) | 비교군, 실험, ablation, 평가 지표 |
| [08-implementation-roadmap.md](./docs/research/08-implementation-roadmap.md) | PoC부터 7B 이상 확장까지 개발 계획 |
| [09-risks-and-mitigation.md](./docs/research/09-risks-and-mitigation.md) | 기술적·연구적·운영적 리스크와 대응 |
| [10-research-positioning.md](./docs/research/10-research-positioning.md) | 기존 연구와의 관계, 차별화 포인트, 논문 주장 |
| [11-repository-and-engineering-plan.md](./docs/research/11-repository-and-engineering-plan.md) | 저장소 구조, 모듈, 실험 관리, 코드 품질 기준 |

### 현재 실행 문서

- [Decoder-only CERPT Base 구현](./docs/implementation/DECODER_ONLY_CERPT_BASE.md)
- [구현 진행 기록](./docs/progress/IMPLEMENTATION_STATUS.md)
- [학습·공개 가이드](./docs/guides/PUBLISHING.md)
