...
def main() -> None:
    ...
    if resume_dir:
        ...
        config = CERPTConfig(vocab_size=len(tokenizer), hidden_size=args.hidden_size, workspace_slots=args.workspace_slots, num_cycles=args.cycles, max_position_embeddings=args.max_length)
