...
def main() -> None:
    ...
    parser.add_argument("--kind", choices=["auto", "text", "causal", "multimodal"], default="auto")
    parser.add_argument("--model-card", default="docs/model-cards/MODEL_CARD.md")
    ...
    if kind == "auto":
        ...
        kind = "multimodal" if model_type == "cerpt-multimodal" else "causal" if model_type == "cerpt_causal" else "text"
